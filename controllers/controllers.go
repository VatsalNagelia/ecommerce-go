...
import (
	...
	generate "github.com/VatsalNagelia/ecommerce-yt/tokens"
...
func VerifyPassword(userEnteredPassword string, actualHashedPassword string) (bool, string) {

	err := bcrypt.CompareHashAndPassword([]byte(actualHashedPassword), []byte(userEnteredPassword))
	valid := true
...
func ProductViewerAdmin() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		defer cancel()
		c.JSON(http.StatusOK, "Successfully added Product Viewer Admin")
	}
}
...
func SearchProduct() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		if err != nil {
			c.IndentedJSON(http.StatusInternalServerError, "Something went wrong, pls try after some time")
			return
		}
...
func SearchProductByQuery() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		if err != nil {
			c.IndentedJSON(404, "Something went wrong while fetching the searched product data")
			return
		}
